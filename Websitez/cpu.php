...
$result = mysqli_query(
$con,
"SELECT * FROM `cpu` WHERE `code`='$code'"
);
...
<h2 class="mobiles">Our Selection of Processors</h2>
<?php
$result = mysqli_query($con,"SELECT * FROM `cpu` LIMIT 0,8");
...
<h2 class="laptops"></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM `cpu` LIMIT 8,8");
while($row = mysqli_fetch_assoc($result)){
...
<h2 class="laptops"></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM `cpu` LIMIT 16,24");
while($row = mysqli_fetch_assoc($result)){
